...
export default function Home() {
  return (
    <>
      <div className="relative flex flex-col sm:flex-row min-h-screen items-center justify-center mb-5">
